...
public class ResumenCompra extends javax.swing.JFrame {
    ...
    private PasesEntradas vAnterior;

    public ResumenCompra(Cliente cliente, Object cineAct, Object paseAct, int num_ent, float importe, PasesEntradas vAnterior) {
        initComponents();
    ...
    private void actualizarDatosPelicula(DetallesPase detallesPase, int num_ent, float importe) {
        DateFormat fecha = new SimpleDateFormat("EEEE dd 'de' MMMM", new Locale("es", "ES"));
        DateFormat hora = new SimpleDateFormat("HH:mm", new Locale("es", "ES"));
        
        this.labelFecha.setText(fecha.format(detallesPase.fecha));
        this.labelHora.setText(hora.format(detallesPase.fecha));
    ...
    private void botonPagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPagarActionPerformed
        if (this.cliente.confirmarCompra() == true) {         
            ...
            JOptionPane.showMessageDialog(this, "Hubo un error en la compra, reintente su compra");
        }
