...
public class TicketCine {
    ...
    public ArrayList<Pelicula> consultarPelisNuevas(Cine _cine) {
        ...
        for (Pelicula pelicula : peliculas) {
            if (_cine.consultarListaCine(pelicula) == true) {
                pelisNuevas.add(pelicula);
            }
        }
        return pelisNuevas;
    }
    ...
    public void cargarDatos() throws Exception {
        ...
        */
        ...
        Pase pase1Peli1Cine1 = new Pase(fpase1, (Object) "14:00", (float) 10, c1, sala1_c1, p1, estadoPase);
        Date fpase2 = new Date(2019, 5, 28, 15, 00, 00);
        Pase pase2Peli2Cine1 = new Pase(fpase2, (Object) "15:00", (float) 10, c1, sala2_c1, p2, estadoPase);
        c1.addPase(pase1Peli1Cine1);
        c1.addPase(pase2Peli2Cine1);
        
        
        Date fpase3 = new Date(2019, 5, 29, 20, 00, 00);
        Pase pase1Peli3Cine2 = new Pase(fpase3, (Object) "20:00", (float) 10, c2, sala1_c2, p3, estadoPase);
        Date fpase4 = new Date(2019, 5, 29, 16, 00, 00);
        Pase pase2Peli4Cine2 = new Pase(fpase4, (Object) "16:00", (float) 10, c2, sala2_c2, p4, estadoPase);
        c2.addPase(pase1Peli3Cine2);
        c2.addPase(pase2Peli4Cine2);
        
        
        Date fpase5 = new Date(2019, 5, 30, 21, 00, 00);
        Pase pase1Peli5Cine3 = new Pase(fpase5, (Object) "21:00", (float) 10, c3, sala1_c3, p5, estadoPase);
        Date fpase6 = new Date(2019, 5, 30, 21, 30, 00);
        Pase pase2Peli6Cine3 = new Pase(fpase6, (Object) "21:30", (float) 10, c3, sala2_c3, p6, estadoPase);
        c3.addPase(pase1Peli5Cine3);
        c3.addPase(pase2Peli6Cine3);
        
        Date fpase7 = new Date(2019, 6, 01, 15, 30, 00);
        Pase pase1Peli7Cine4 = new Pase(fpase7, (Object) "15:30", (float) 10, c4, sala1_c4, p7, estadoPase);
        Date fpase8 = new Date(2019, 6, 01, 14, 30, 00);
        Pase pase2Peli8Cine4 = new Pase(fpase8, (Object) "14:30", (float) 10, c4, sala2_c4, p8, estadoPase);
